    ...
    <div class="skills-item"
        ...
        <div class="skills-item-content">
            ...
            <div class="skills-item-header eq-h6">
                <!-- Title -->
                <span class="skills-item-header-title font-mono">
                    <span class="fw-bold font-weight-semibold"
                ...
                <span v-if="percentageDisplay && progressBarAllowed"
                      class="skills-item-percentage-display text-1 font-mono font-weight-semibold"
